...
const Login =()=>{
  ...
  return(
    ...
    <div className=" containe flex flex-row w-full h-[full] overflow-hidden">
          <div className="flex h-[1024px] w-full flex-col justify-between bg-[#4285F4] p-16">

            <span className="text-2xl font-bold text-white">
             
              LOGO</span>
     
            <span className="flex items-stretch place-self-center text-[72px] font-bold text-white">
              Board.
            </span>
            <div className="pb-20 flex w-[299px] flex-row items-center justify-between gap-2 place-self-center">
              <svg
                width="45"
                height="44"
                viewBox="0 0 45 44"
          ...
          <div className="flex w-full place-content-center items-center  bg-[#F8FAFF]">
            <div className="flex flex-col gap-7 ">
              ...
              <div className="flex flex-row items-center gap-7">
                <div className="flex flex-row items-center gap-2 rounded-2xl bg-white p-4 text-xs text-[#858585]">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                  ...
                  <span className='cursor-pointer' onClick={() => loginWithRedirect()}>Sign in with Google</span>
                </div>
                <div className="flex flex-row items-center gap-2 rounded-2xl bg-white p-4 text-xs text-[#858585]">
                  <svg
                    width="14"
                  ...
                  <span onClick={() => loginWithRedirect()} className='cursor-pointer'>Sign in with Apple</span>
                </div>
              </div>
              <div className="flex flex-col gap-7 rounded-xl bg-white p-8 shadow-lg">
                <div className="flex flex-col gap-2  text-base font-normal text-black">
                  <span className=" ">Email address</span>
                  <input
                    type="text"
                    placeholder="Enter your email "
                    className="rounded-lg border border-[#F5F5F5] bg-[#F5F5F5] text-xs"
                  />
                </div>
                <div className="flex flex-col gap-2 text-base font-normal text-black">
                ...
                <p className=" cursor-pointer text-base font-normal text-[#346BD4]">
                  Forgot password?
                </p>
                <button className="w-[357px] rounded-lg bg-[#4285F4] py-2 text-base font-bold text-white cursor-pointer">
                  Sign In
                </button>
              </div>
              <span className=" flex justify-center text-base font-normal  text-[#858585]">
